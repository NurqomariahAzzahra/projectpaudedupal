    ...
    <div class="container-fluid bg-light position-relative shadow">
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0 px-lg-5">
            <a href="" class="navbar-brand font-weight-bold text-secondary" style="font-size: 40px;">
                ...
                <!-- <a class="nav-brand" href="/"><img src="{{ asset('img/icons') }}/logo.png" width="80" alt=""> Edupal</a> -->
                <img class="img-fluid rounded mb-5 mb-lg-0" src="{{ asset('img/icons') }}/logo.png" style="width:100px; height:auto;"></i>
                <!-- <div class="col-lg-5">
    ...
    <!-- <div class="container-fluid py-5">
        <div class="container p-0">
            <div class="text-center pb-2">
                <p class="section-title px-5"><span class="px-2">Popular</span></p>
