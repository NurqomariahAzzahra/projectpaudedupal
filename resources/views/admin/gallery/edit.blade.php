...
<div class="">    
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Box Gallery</h4>
        </div>
        <div class="card-body">
        <form method="POST" enctype="multipart/form-data" action="{{ route('admin.gallery.update',$gallery->id) }}">
            ...
            <div class="form-group">
                ...
                <input value="{{ $gallery->nama_gallery }}" required="" type="" name="nama_gallery" placeholder="" class="form-control"> 
            </div>
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
            ...
            <div id="form-group">
                <label for="deskripsi">Isi Gallery</label>
                <textarea required="" name="deskripsi" id="deskripsi" class="text-dark form-control summernote">{{ $gallery->deskripsi_gallery }}</textarea>
            </div>
        </div>
