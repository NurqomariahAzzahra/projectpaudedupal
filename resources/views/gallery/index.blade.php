    ...
    <div class="col">
        <div class="card">
            <div class="card-header">
                <a href="/gallery/create" class="btn btn-primary btn-sm">Tambah Data</a>
            </div>
            <div class="card-body table-responsive">
                ...
                <td>{{ $no++ }}</td>
                  ...
                  <td>{{ $gal->jenis}}</td>
                  <td>{{ $gal->gambar_gallery}}</td>
                  <td>{{ $gal->deskripsi_gallery}}</td>
                  ...
                  <td>
                    ...
                    <div class="row ml-2">
                        ...
                        <form method="POST" action="{{ route('admin.artikel.destroy',$gal->id) }}">
                            @csrf
                            @method('DELETE')
